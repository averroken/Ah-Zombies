...
TopDownGame.Menu.prototype = {
    create: function () {
        ...
        var bg = TopDownGame.game.add.tileSprite(0, -10, 810, 613, 'city');
        bg.fixedToCamera = true;

        this.gameTitle = TopDownGame.game.add.image(TopDownGame.game.camera.width / 2, TopDownGame.game.camera.height / 2 - 150, 'menu_title');
    ...
    update: function () {
        if(this.justExitedSubmenu) {
            ...
            if(this.input.keyboard.isDown(Phaser.Keyboard.DOWN) && this.arrow.canMove && this.currentButton < 3) {
