...
TopDownGame.largeMap = function() {};

TopDownGame.largeMap.prototype = {
    create: function() {
        this.map = this.game.add.tilemap('largeMap');
    ...
    enterDoor: function(player, door) {
        ...
        TopDownGame.game.state.start('Level2');
    },
    update: function() {
